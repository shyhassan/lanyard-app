...
export const hooksList = [
  ...
  { name: "PVC Snap Clip", src: pvcscPvcSnapclip },
  ...
  { name: "YBDBKL Non Swivel", src: ybdbklNonSwivel },
  { name: "YBDBKL Swivel", src: ybdbklSwivel },
  { name: "YBDNSA D/R Black", src: ybdnsaDRBlack },
  { name: "YBDNSA D/R Silver", src: ybdnsaDRSilver },
  { name: "Bulldog Black Non Swivel", src: ybdnsnaNonSwivelBulldog },
  { name: "Bulldog Nic Non Swivel", src: ybdnsnaNicNonSwivelBulldog },
  { name: "Bulldog Keyring", src: ybdscWithKeyringBulldog },
  { name: "Bulldog Keyring Snapclip", src: ybdscWithKeyringBulldogSnapclip },
  { name: "YCELL Large", src: ycellLarge },
  { name: "YCELL Small", src: ycellSmall },
  { name: "Deluxe Lobster", src: ydsDeluxeLobster },
  { name: "Deluxe Lobster Black", src: ydsblkDeluxeLobsterBlack },
  { name: "J Hook", src: yjhJHook },
  { name: "J Hook Pinhole", src: yjhPinholesJHookPinhole },
  { name: "J Hook Black", src: yjhblkJHookBlack },
  { name: "J Hook Eagle Claw", src: yjhecJHookEagleClaw },
  { name: "J Hook Euro", src: yjheuJHookEuro },
  { name: "J Hook Non Swivel", src: yjhnsJHookNonSwivel },
  { name: "J Hook Non Swivel Gun Metal", src: yjhnsGunJHookNonSwivelGunMetal },
  { name: "J Hook Non Swivel Black", src: yjhnsblkJHookNonSwivelBlack },
  { name: "Snaphook Plastic", src: yjhplaSnaphookPlastic },
  { name: "J Hook Detachable Buckle", src: ymdaJHookDetachableBuckle },
  { name: "Detachable Buckle", src: ymdbDetachableBuckle },
  { name: "Split Ring Detachable Buckle", src: ymdbblkSplitRingDetachableBuckle },
  { name: "Bulldog Detachable Buckle", src: ymddcBulldogDetachableBuckle },
  { name: "ID Holder Detachable Buckle", src: ymddIdHolderDetachableBuckle },
  { name: "Holder X Detachable Buckle", src: ymdeHolderXDetachableBuckle },
  { name: "Black Metal Hook Detachable", src: ymdjBlckBlackMetalHookDetachable },
  { name: "Gun Metal Hook Detachable", src: ymdjGunm1GunMetalHookDetachable },
  { name: "Metal Hook Detachable", src: ymdjNcklMetalHookDetachable },
